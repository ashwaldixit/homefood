...
public class HomeFoodInfoException extends RuntimeException {

	private ExceptionMessage exceptionMessage;
	private static final long serialVersionUID = -706783001803490307L;

	public HomeFoodInfoException(String message, NotificationInfo notificationinfo, int errorCode) {
		super(message);
