...
public interface ProductOrderRepository extends JpaRepository<ProductOrder, Serializable> {
	...
	public List<ProductOrder> findByCustomer(Customer customer);

	public List<ProductOrder> findByCustomerAndOrderStatus(Customer customer, OrderStatus orderStatus);

	public List<ProductOrder> findByCustomerAndProduct(Customer customer, Product product);
